...
export function ProfilePage() {
  ...
  const originalAttempted = questionEntries.filter((entry) => entry.kind === 'original' && (entry.attempts || entry.lastAnswers.some(Boolean))).length;
    ...
    <div className="profile-page page-shell">
      ...
      <div className="profile-hero">
        <div><p className="eyebrow">YOUR SPACE / PRIVATE BY DESIGN</p><h1>Study profile<span className="period">.</span></h1>
          <p>Your reading, practice, focus time, and tutor settings in one place. Stored in this browser, not on our servers.</p></div>
      ...
      {active && <>
        <div className="profile-welcome"><div><p className="eyebrow">GOOD TO HAVE YOU HERE</p>
          ...
          <p>Local, encrypted, and yours to take with you.</p></div>
        ...
        <div className="profile-grid">
          <section className="profile-card"><p className="eyebrow">01 / THE WORK</p><h2>Your progress</h2>
            ...
            <div className="profile-progress-list">
              <ProgressRow label="Original notes" value={includedStudied} total={20} to="/units" />
              ...
              <ProgressRow label="Original question bank" value={originalAttempted} total={16} to="/question-bank" />
              <ProgressRow label="IB Paper 1 + Paper 2" value={paperAttempted} total={50} to="/ib-papers" />
        ...
        <div className="profile-section-heading"><p className="eyebrow">KEEP A COPY</p><h2>Back up & move<span className="period">.</span></h2>
          <p>Take your encrypted profile to another browser. Keep its password separately. There is no account sync or password recovery server.</p></div>
        <div className="profile-grid">
