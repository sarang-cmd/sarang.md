  ...
  return (
    <div className="mx-auto w-full max-w-[1320px] px-5 pb-24 pt-14 sm:px-9 sm:pt-20 lg:px-12 xl:px-16 xl:pt-24">
      ...
      <section aria-label="More ways to study" className="mt-4 grid gap-4 md:grid-cols-2">
        <Link to="/ib-papers" className="group flex items-start gap-4 rounded-xl border border-line p-6 transition-colors hover:border-ink hover:bg-surface"><span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-surface"><FileQuestion size={19} strokeWidth={1.7} /></span><span className="min-w-0 flex-1"><span className="section-label">03 / Paper practice</span><strong className="mt-2 block text-[18px] tracking-tight">Paper 1 or Paper 2.</strong><span className="mt-1 block text-[12px] leading-relaxed text-muted">Your two transcriptions, original variants and an answer checker. Source notes are clearly labeled.</span></span><ArrowUpRight size={16} className="shrink-0 text-muted" /></Link>
